...
import { CRUDState, createCRUDReducer, CreateCRUDReducerOptions, CRUDReducer } from './crudReducer';
import { Key, getCRUDActionsCreator, CRUDActionCreators, CRUDActionTypes, AllowedNames } from './crudAction';
import { bindDispatch, Dispatched } from './bindDispatch';

export type UseCRUDReducer<I, K extends Key<I>, Prefill extends boolean = true> = () => [
  CRUDState<I, Prefill>,
  Dispatched<CRUDActionCreators<I, K>>
];

export interface CreateUseCRUDReducerOps<I, K extends AllowedNames<I, string>, Prefill extends boolean = true>
